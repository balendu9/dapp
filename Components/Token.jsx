              ...
              <div className="row">
                <div className="col-12 col-lg-5">
                  <div className="invest__rate-wrap">
                    <div className="invest__rate">
                      ...
                      <p>{poolDetails?.depositToken.totalSupply} {""} {poolDetails?.depositToken.symbol}</p>
                    </div>
                ...
                <div className="col-12 col-lg-5 offset-lg-1">
                  <div className="invest__rate-wrap">
                    <div className="invest__rate">
                      ...
                      <p className="green">{poolDetails?.depositToken.contractTokenBalance.slice(0,10)} {poolDetails?.depositToken.symbol}</p>
                    </div>
                ...
                <div className="col-12 col-lg-5 ">
                  <div className="invest__rate-wrap">
                    <div className="invest__rate">
                      ...
                      <p className="red">{poolDetails?.rewardToken.totalSupply} {poolDetails?.rewardToken.symbol}</p>
                    </div>
                    <div className="invest__graph">
                ...
                <div className="col-12 col-lg-5 offset-lg-1">
                  <div className="invest__rate-wrap">
                    <div className="invest__rate">
                      <span>Total Stake</span>
                      <p className="green">1 TNC = 0.01 BNB</p>
                    </div>
                    <div className="invest__graph">
