        ...
        <div className="row">
          <div className="col-12">
            <div className="header__content">
              ...
              <a href="/" className="header__logo"><img src="img/logo.svg" alt="TECHS NETWORK" /></a>
              <span className="header__tagline">TECHS NETWORK</span>
              <ul className="header__nav" id="header--nav">
                {navigation.map((item, index) => (
                  <li key={index}>
                    <a href={page == "activity"? "/": page == "admin" ? "/" : `${item.link}`}>
                      {item.name}
                    </a>
                  </li>
                ))}
