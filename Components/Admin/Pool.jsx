...
const Pool = ({ poolDetails, createPool, setLoader, setModifyPoolID}) => {
  ...
  const [poolDetails, setPool] = useState({
    _depositToken:"",
    _rewardToken:"",
    _apy:"",
    _lockDays:"",
                              ...
                              <tr key={index}>
                                ...
                                <td>
                                  ...
                                  <span className="green">
                                    {SHORTEN_ADDRESS(pool.rewardTokenAddress)}{""} &nbsp; &nbsp; {pool._rewardToken.symbol} &nbsp; &nbsp;
                                ...
                                <td>
                                  <div className="deals__text deals__text--green">
                                    {pool.depositedAmount} &nbsp; <span className="red">{pool.depositToken.symbol}</span>
                                  </div>
                                </td>
                                <td>
                                ...
                                <td>
                                  <div className="deals__text deals__text--sell">{pool._lockDays} days</div>
                                </td>
                                <td>
