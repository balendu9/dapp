    ...
    <div className="col-12">
      <div className="invest invest--big">
        ...
        <div className="invest__group">
          <input type="text" id="partnerlink" name="partnerlink"
            className="form__input" defaultValue={`${ADDRESS_EXPLORER} ${STAKING_DAPP}`}  
          />
          <p className="invest__text">
            Stake Token TECHS NETWORK Best return on investment
          </p>
          <table className="invest__table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="{`${TOKEN_EXPLORER}${TOKEN}`" style={{marginLeft: "10px"}} target="_blank" className="header__profile">
