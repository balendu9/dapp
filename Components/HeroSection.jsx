...
const CURRENCY = proces.env.NEXT_PUBLIC_CURRENCY;
          ...
          <div className="col-12 col-lg-7 col-xl-6">
            <div className="hero__content hero__content--first">
              ...
              <div className="hero__btns">
                ...
                <a onClick={() => addTokenMetaMask()} className="hero__btn hero__btn--light">Add Token {tokenDetails?.symbol || ""}</a>
              </div>
            </div>
          </div>
          {/* 2 */}
          ...
          <div className="col-12 col-md-6 col-lg-5 col-xl-4 offset-xl-2">
            <div className="hero__content hero__content--second">
              <div className="node node--hero">
                <h3 className="node__title mode__title--red">
                ...
                <span className="node__price">
                  ICO left: <b>{tokenDetails?.tokenBal || ""} {tokenDetails?.symbol}</b>
                </span>
                ...
                <ul className="node__list">
                  <li>
                    ...
                    <b>1.1%</b> of the deposited amount
                  </li>
                  <li>
                    <i className="ti">
                      <TiTick />
                ...
                <div className="progressbar progressbar--cta">
                  ...
                  <div className="progress" role="progressbar" 
                    ...
                    aria-valuemax={100}
                  >
                    <div className="progress-bar progress-bar-stried progress-bar-animated" style={{width: `${percentage}%`}}>
